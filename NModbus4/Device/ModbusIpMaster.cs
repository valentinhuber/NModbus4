...
namespace Modbus.Device
{
    ...
    public class ModbusIpMaster : ModbusMaster
    {
        ...
        [SuppressMessage("Microsoft.Naming", "CA1706:ShortAcronymsShouldBeUppercase", Justification =
            "Breaking change.")]
 ...
 "Breaking change.")]
        ...
        public byte SlaveUnitId { get; set; } = Modbus.DefaultIpSlaveUnitId;
        ...
        {
            return base.ReadCoils(SlaveUnitId, startAddress, numberOfPoints);
        }
        ...
        {
            return base.ReadCoilsAsync(SlaveUnitId, startAddress, numberOfPoints);
        }
        ...
        {
            return base.ReadInputsAsync(SlaveUnitId, startAddress, numberOfPoints);
        }
        ...
        {
            return base.ReadHoldingRegistersAsync(SlaveUnitId, startAddress, numberOfPoints);
        }
        ...
        {
            return base.ReadInputRegistersAsync(SlaveUnitId, startAddress, numberOfPoints);
        }
        ...
        {
            base.WriteSingleCoil(SlaveUnitId, coilAddress, value);
        }
        ...
        {
            return base.WriteSingleCoilAsync(SlaveUnitId, coilAddress, value);
        }
        ...
        {
            base.WriteSingleRegister(SlaveUnitId, registerAddress, value);
        }
        ...
        {
            return base.WriteSingleRegisterAsync(SlaveUnitId, registerAddress, value);
        }
        ...
        {
            base.WriteMultipleRegisters(SlaveUnitId, startAddress, data);
        }
        ...
        {
            return base.WriteMultipleRegistersAsync(SlaveUnitId, startAddress, data);
        }
        ...
        {
            base.WriteMultipleCoils(SlaveUnitId, startAddress, data);
        }
        ...
        {
            return base.WriteMultipleCoilsAsync(SlaveUnitId, startAddress, data);
        }
